...
let mils= document.getElementById("miles");
...
function convertTOthers(convertForm,value){
    switch(convertForm){
        case "feet" : feetOthers(parseFloat(value)); break;
        case "meter" : meterOthers(parseFloat(value)); break;
        case "inch" : inchsOthers(parseFloat(value)); break;
        case "cm" : cmOthers(parseFloat(value)); break;
        case "yard" : yardsOthers(parseFloat(value)); break;
        case "km" : kmOthers(parseFloat(value)); break;
        case "mile" : milesOthersToOthers(parseFloat(value)); break;
    }
}
